...
React/Vite interface for an OpenAI-compatible Shiftwing server.
...
`./c/shiftwing web --model c/qwen35 --cuda` to build the bundle and serve it from
...
Shiftwing-specific `cache_slot` field only when KV-slot support was advertised.
