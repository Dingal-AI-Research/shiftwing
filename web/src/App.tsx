    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <section className="side-section">
          ...
          <label><span className="label-line"><span>{t("sidebar.temperature")}</span><code>{temperature.toFixed(1)} · greedy</code></span><input aria-label="Greedy decoding is fixed in Gate 9" className="range" type="range" min="0" max="0" step="0.1" value={temperature} disabled /></label>
